...
namespace shield
{
  ...
  public:
    ...
    /****************LZC Added****************/
    bool checkLine(const Eigen::Vector3d &cur_pt, const Eigen::Vector3d &end_pt, int type);
    bool checkPath(const vector<Eigen::Vector3d> &path);
    bool updateWaypoint(const vector<Eigen::Vector3d> &path, const Eigen::Vector3d &cur_pt, Eigen::Vector3d &next_pt, int interval);
    /*****************************************/
